export const skyParksData = {
  en: {
    seo: {
      title: "Sobha SkyParks | Luxury Apartments in Dubai | Sobha Realty",
      description:
        "81-storey luxury residential tower offering 1–4 bedroom apartments with panoramic Dubai views on Sheikh Zayed Road.",
      keywords:
        "sobha sky parks, dubai apartments, sobha realty, sheikh zayed road luxury",
      canonical: "/projects/apartments/sobha/sky-parks",
    },
      ...
      brochures: [
        {
          ...
          url: "https://luxury-real-estate-media.b-cdn.net/sky-parks/SOBHA-SKYPARKS-BROCHURE.pdf",
          type: "main",
        },
      ],
      imgUrl:
        "https://luxury-real-estate-media.b-cdn.net/sky-parks/intro-main.jpg",
    ...
    gallery: {
      ...
      slides: [
        "https://luxury-real-estate-media.b-cdn.net/sky-parks/exterior-pool-01.jpg",
        "https://luxury-real-estate-media.b-cdn.net/sky-parks/exterior-sunrise-01.jpg",
  ...
  ar: {
    seo: {
      title:
        "Sobha SkyParks | شقق فاخرة في دبي على شارع الشيخ زايد | شوبا العقارية",
      description:
        "برج سكني بارتفاع 81 طابقاً يقدّم شققاً من غرفة إلى أربع غرف نوم بإطلالات بانورامية على دبي، في موقع مميّز على شارع الشيخ زايد.",
      keywords:
        "Sobha SkyParks، شوبا سكاي باركس، شقق دبي، شارع الشيخ زايد، شوبا العقارية، برج سكني فاخر دبي",
      canonical: "/projects/apartments/sobha/sky-parks",
    },
    ...
    project: {
      ...
      status: "قيد التطوير",
      startingPrice: "2,880,250 درهم إماراتي",
    ...
    intro: {
      title: "سكن على ارتفاع يطل على أفق دبي",
      paragraphs: [
        "يرتفع برج «Sobha SkyParks» على شارع الشيخ زايد ليقدّم تجربة سكنية واضحة المعالم: موقع مركزي، ارتفاع شاهق، وإطلالات مفتوحة على أفق دبي. يضعك المشروع في قلب المدينة، على مقربة من المراكز المالية، والمطاعم الراقية، والعلامات العالمية.",
        "يضم البرج شققاً من غرفة إلى أربع غرف نوم، بالإضافة إلى دوبلكسات أنيقة، جميعها بتصميم داخلي مدروس وإطلالات واسعة على الخليج العربي وأفق وسط مدينة دبي. تتناغم حركة المدينة في الأسفل مع هدوء المساحات العلوية، لتعيش توازناً عملياً بين الحياة اليومية والإحساس بالخصوصية.",
      ],
      brochures: [
        {
          title: "تحميل الكتيّب",
      ...
      imgUrl:
        "https://luxury-real-estate-media.b-cdn.net/sky-parks/intro-main.jpg",
      imgAlt: "واجهة برج Sobha SkyParks السكني",
      floatingCards: [
        {
          top: "20%",
          right: "-30px",
      ...
      plans: [
        ...
        },
        {
          ...
          specs: {
            ...
            "المساحة الداخلية": "1,107.18 قدم مربع",
            "مساحة الشرفة": "80.84 قدم مربع",
            "إجمالي المساحة": "1,188.02 قدم مربع",
    ...
    amenities: {
      title: "مرافق تعكس مستوى البرج",
      amenities: [
        { label: "ملعب بادل", icon: "🎾", color: "#d7b46a" },
        { label: "حوض سباحة إنفينيتي", icon: "🏊", color: "#d7b46a" },
        {
          label: "منطقة يوغا وتراس للتأمل",
          icon: "🧘",
          color: "#d7b46a",
        },
        {
          label: "مساحات تمارين كاليسثينكس",
          icon: "💪",
          color: "#d7b46a",
        },
        { label: "تراسات عائمة بإطلالات مفتوحة", icon: "🌊", color: "#d7b46a" },
    ...
    location: {
      ...
      proximityFeatures: [
        ...
        { icon: "🏙️", text: "وصول مباشر إلى وسط مدينة دبي" },
        { icon: "🛣️", text: "قرب من الطرق السريعة الرئيسية" },
      ],
    },

    nearbyAttractions: {
      title: "قربك من أهم المعالم",
      attractions: [
        {
          name: "وسط مدينة دبي",
          distance: "5 دقائق",
