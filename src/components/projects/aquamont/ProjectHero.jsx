...
export default function ProjectHero({
  backgroundUrl = "https://luxury-real-estate-media.b-cdn.net/aquamont/hero-bg.png",
  squareImageUrl = "https://luxury-real-estate-media.b-cdn.net/aquamont/hero-inset.jpg",
